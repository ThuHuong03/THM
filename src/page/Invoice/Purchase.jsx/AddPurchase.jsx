...
export default function AddPurchase({ OnClickCancel }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white text-black p-8 rounded-lg shadow-lg max-h-[80vh]  max-w-[600px] overflow-y-auto">
        ...
        <div className="flex flex-row justify-between m-5">
          ...
          <label className="font-bold text-xl">Không </label> <ToggleButton /> <label className="font-bold text-xl">Có</label>
        </div>
        <label className="font-bold text-2xl mb-2 mt-2">In phiếu không?</label>
        <div className="flex flex-row justify-between  m-5">
