...
export default function EditProvider({OnClickCancel, provider}) {
  ...
  const handleSubmit = async () => {
    ...
    const updateCustomer = new Provider({
        ...formData,
    ...
    try {
        await updateCustomer.updateDetails(host, getProviders); // Ensure host is passed here
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white text-black p-8 rounded-lg shadow-lg max-h-[80vh]  max-w-[600px] overflow-y-auto">
        <h2 className="text-3xl font-bold mb-4 text-dark-rust">Chỉnh sửa Nhà Cung Cấp</h2>
