...
export default function EditAgency({OnClickCancel, agency}) {
  ...
  const {host, getAgencies} = useContext(AppContext);
  ...
  const handleSubmit = async () => {
    ...
    try {
        await updateAgency.updateDetails(host, getAgencies); 
     
        OnClickCancel(); 
    } catch (error) {
        console.error("Error in editing agency:", error);
        alert('Chỉnh sửa thông tin đại lý thất bại');
    }
};
